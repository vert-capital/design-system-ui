  ...
  return (
    <TooltipProvider>
      <DayPicker
        ...
        modifiersClassNames={{
          booked: "border-2 border-dashed border-brand/50 hover:border-brand",
          today: "border-dashed border-2 hover:border-muted-foreground",
        }}
        components={{
          ...props.components,
          IconLeft: ({ ...props }) => (
